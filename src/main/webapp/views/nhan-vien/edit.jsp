...
<div class="container">
    <h1>Sửa Nhân Viên</h1>
    <div class="row py-2">
        <form action="/QuanLiCuaHang_war_exploded/nhan-vien/update?id=${nhanVien.id}" method="POST">
            <div class="row mb-3">
                <div class="col-md-6">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="idCV">
                        ...
                        <c:forEach items="${listChucVu}" var="lCV">
                            <option value="${lCV.id}" ${lCV.id == nhanVien.idCV ? 'selected' : ''}>${lCV.ten}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="idCH">
                        ...
                        <c:forEach items="${listCuaHang}" var="lCH">
                            <option value="${lCH.id}" ${lCH.id == nhanVien.idCH ? 'selected' : ''} >${lCH.ten}</option>
                        </c:forEach>
                    </select>
                </div>
                <div class="col-md-4">
