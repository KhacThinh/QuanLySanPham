...
<div class="container">
    <div class="row py-2">
        <form action="/QuanLiCuaHang_war_exploded/khach-hang/insert" method="POST">
            <div class="mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="sdt" class="form-control" min="0" maxlength="10"/>
                </div>
            </div>
            <div class="row mb-3">
                <div class="col-md-4">
            ...
            <a href="/QuanLiCuaHang_war_exploded/khach-hang/index" class="btn btn-secondary"><i
