...
<div class="container">
    <div class="row py-5">
        ...
        <a href="/QuanLiCuaHang_war_exploded/chuc-vu/create" class="btn btn-primary"><i class="bi bi-person-add"></i>
            Thêm</a>
    </div>
    <table class="table table-striped table-hover">
        ...
        <c:forEach var="chucVu" items="${list}">
            <tr>
                ...
                <td>${chucVu.ma}</td>
                <td>${chucVu.ten}</td>
                <td><a href="/QuanLiCuaHang_war_exploded/chuc-vu/edit?id=${chucVu.id}"
