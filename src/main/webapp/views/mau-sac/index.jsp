...
<div class="container">
    <div class="row py-5">
        ...
        <a href="/QuanLiCuaHang_war_exploded/mau-sac/create" class="btn btn-primary"><i class="bi bi-person-add"></i>
            Thêm</a>
    </div>
    <table class="table table-striped table-hover">
        ...
        <c:forEach var="mauSac" items="${list}">
            <tr>
                ...
                <td>${mauSac.ma}</td>
                <td>${mauSac.ten}</td>
                <td><a href="/QuanLiCuaHang_war_exploded/mau-sac/edit?id=${mauSac.id}"
